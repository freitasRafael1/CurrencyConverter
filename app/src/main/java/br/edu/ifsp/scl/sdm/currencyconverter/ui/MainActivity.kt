...
import br.edu.ifsp.scl.sdm.currencyconverter.model.livedata.CurrencyConverterLiveDate
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CurrencyConverterLiveDate.currenciesLiveData.observe(this){currencyList ->
        ...
        CurrencyConverterLiveDate.conversionResultLiveData.observe(this) { conversionResult ->
            with(amb) {
